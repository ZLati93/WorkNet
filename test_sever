...
gig_data = {
    ...
    "category_id": "64f123456789abcdef012345",  # ID catégorie fictive
    "price": 100
}
...
cat = rpc.categories.create_category("Développement", "Catégorie test")
pp.pprint(cat)
cat_id = cat
...
complaint = rpc.complaints.create_complaint(user_id, user_id, "user", "Spam", "Test plainte")
pp.pprint(complaint)
...
# Ici tu peux appeler rpc.reviews.create_review, rpc.payments.create_payment etc.
# Exemples :
